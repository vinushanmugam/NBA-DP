  ...
  return(
    <div>
      ...
      {[
        ...
        {title:"Offensive Turnover Rate: The Only Unresolved Flaw",conf:78,col:"#EF4444",attr:"Scheme + Roster",flag:"RISK",detail:"15.2% Off TOV% (23rd NBA), up from 14.1% in 2024-25. Root causes: (1) Cade is sole half-court creator — when pressured, no reliable secondary handler; (2) Duren's post passing still developing; (3) Giddey (career 3.7 TOV/game) adds lineup risk. Fix: low-TOV secondary creator via trade, simpler half-court sets, or reduced Giddey crunch-time usage. This is potentially the margin between a R1 exit and a Finals run."},
